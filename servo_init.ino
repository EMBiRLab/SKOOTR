...
const int leg1offset1 = -1; // start by setting these all to 0, and change them until each leg points straight
                            // out from the body parallel to the floor (remove center ball from robot)
